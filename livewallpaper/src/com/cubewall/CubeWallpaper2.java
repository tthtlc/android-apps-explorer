...
public class CubeWallpaper2 extends WallpaperService {
	...
	private String TERESE = "TERESE";
	private String JEROME = "JEROME";
	private String mytext;
		...
		counter = 0;
		name_counter++;
	    	if (name_counter > 2) name_counter = 0;
	    }
/*
	    switch(counter) {
		case counter: 
...
*/
	    if (name_counter == 2) mytext = CLAIRE.toString();
	    if (name_counter == 1) mytext = TERESE.toString();
	    if (name_counter == 0) mytext = JEROME.toString();
            c.drawText(mytext, startX, startY, mPaint);
